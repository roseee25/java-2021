...
public class C03_LinkedList {
	...
	public static void main(String[] args) {
        ...
        System.out.println( ll.peek()); // 5  Silmeden ilk elemani bana getirir
        System.out.println(ll.peekFirst()); // 5 Silmeden ilk elemani bana getirir
        
       
        LinkedList<Integer> ll2 = new LinkedList<>();
        
        System.out.println(ll2.peekFirst()); // null deque
        System.out.println(ll2.peek()); // null deque
